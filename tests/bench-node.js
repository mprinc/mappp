...
(function() {
  var _, bench, counter, i, iS, j, map, obj, mappp;
  ...
  bench('mappp.js map eachKey function', function() {
  ...
  bench('mappp.js map eachVal function', function() {
  ...
  bench('mappp.js map each function', function() {
  ...
  bench('mappp.js map iterKey function', function() {
    var k, l, ref, results;
    results = [];
  ...
  bench('mappp.js map iterVal function', function() {
    var l, ref, results, v;
    results = [];
    for (i = l = 0, ref = map.length; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
      v = map.iterVal(i);
  ...
  bench('mappp.js map iter function', function() {
